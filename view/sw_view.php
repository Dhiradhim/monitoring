              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <?php
						$kd= $_GET['kd_sw'];
						$svr = mysqli_query($con, "SELECT * FROM tb_sw WHERE kd_sw='$kd'") or die(mysqli_connect_error());
					...
					$count = 1;
					  ?>
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="sw_proses_edit.php" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kd">Kode Switch                        </label>
                        <div class="col-md-2 col-sm-2 col-xs-4">
                          <input readonly="readonly" type="text" id="kd" name="kd"required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['kd_sw']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="merk" name="merk" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['merk_sw']?>">
                        </div>
		      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type">Type                      </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="type" name="type" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['type_sw']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="pn" name="pn" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['pn_sw']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="sn" name="sn" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['sn_sw']?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="ket" name="ket" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['ket_sw']?>">
                        </div>
                      </div>
						<div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <?php
					$q_svr = mysqli_query($con, "SELECT * FROM tb_track WHERE kd_barang='$kd'") or die(mysqli_connect_error());
			  ...
			  <thead>
                ...
                <?php do { ?>
				  ...
				  ?>
					...
					<input type="hidden" id="tb" name="tb" value="sw">
						<div class="form-group">
                        <div class="col-md-12">
                        </div>
                      </div>
