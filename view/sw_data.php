            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                     <li><a href="sw_input.php"><i class="fa fa-pencil-square-o pull-right"></i>Input New Data</a></li>
                  </ul>
                </li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <?php
					$q_svr = mysqli_query($con, "SELECT * FROM tb_sw ORDER BY no_sw") or die(mysqli_connect_error());
			  ...
			  <thead>
                ...
                <?php do { ?>
                  <tr>
                    ...
                    <td><div align="center"><?php echo $row_svr['kd_sw']; ?></div></td>
                    <td><div align="center"><?php echo $row_svr['merk_sw']; ?></div></td>
                    <td><div align="center"><?php echo $row_svr['type_sw']; ?></div></td>
                    <td><div align="center"><?php echo $row_svr['pn_sw']; ?></div></td>
                    <td><div align="center"><?php echo $row_svr['sn_sw']; ?></div></td>
                    ...
                    <td><div align="center">
					<a href="sw_view.php?kd_sw=<?=$row_svr['kd_sw']?>" title="View"> <img src="../images/application.png" width="16" height="16" /></a>  
					</a></div></td>
                </tr>
                  <?php 
				  $count++;
