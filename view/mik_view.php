              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                      <?php
						$kd= $_GET['kd_mik'];
						$svr = mysqli_query($con, "SELECT * FROM tb_mik WHERE kd_mik='$kd'") or die(mysqli_connect_error());
					...
					$count = 1;
					  ?>
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="mik_proses_edit.php" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kd">Kode Router 
                        </label>
                        <div class="col-md-2 col-sm-2 col-xs-4">
                          <input readonly="readonly" type="text" id="kd" name="kd"required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['kd_mik']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="type" name="type" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['type_mik']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="sn" name="sn" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['sn_mik']?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" type="text" id="ket" name="ket" class="form-control col-md-7 col-xs-12" value="<?php echo $row_svr['ket_mik']?>">
                        </div>
                      </div>
					 <div class="form-group">
			  ...
			  <thead>
                ...
                <?php do { ?>
				  ...
				  ?>
					...
					<input type="hidden" id="tb" name="tb" value="mik">
						<div class="form-group">
                        <div class="col-md-12">
                        </div>
                      </div>
