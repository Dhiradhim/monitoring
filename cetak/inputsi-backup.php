        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="savesi.php" method="post">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nosi">No. Delivery Note<span class="required">*</span>
                        </label>
		  ...
		  <div class="form-group">
			...
			<br />
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang1">Nama Barang 1 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang1" name="namabarang1">
			  <br>
                          <textarea type="text" id="remark1" name="remark1" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang2">Nama Barang 2 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang2" name="namabarang2">
			  <br>
                          <textarea type="text" id="remark2" name="remark2" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang3">Nama Barang 3 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang3" name="namabarang3">
			  <br>
                          <textarea type="text" id="remark3" name="remark3" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
...
<!DOCTYPE html>
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang4">Nama Barang 4 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang4" name="namabarang4">
			  <br>
                          <textarea type="text" id="remark4" name="remark4" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang5">Nama Barang 5 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang5" name="namabarang5">
			  <br>
                          <textarea type="text" id="remark5" name="remark5" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                      ...
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang6">Nama Barang 6 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang6" name="namabarang6">
			  <br>
                          <textarea type="text" id="remark6" name="remark6" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                          <input type="text" id="qt6" name="qt6" placeholder="Qty" class="form-control col-md-1 col-xs-12">
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                          <input type="text" id="unit6" name="unit6" placeholder="Unit" class="form-control col-md-6 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="namabarang7">Nama Barang 7 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control" id="namabarang7" name="namabarang7">
			  <br>
                          <textarea type="text" id="remark7" name="remark7" placeholder="Remark"  class="form-control col-md-5 col-xs-12"></textarea>
			</div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                          <input type="text" id="qt7" name="qt7" placeholder="Qty" class="form-control col-md-1 col-xs-12">
                        </div>
                        <div class="col-md-1 col-sm-1 col-xs-12">
                          <input type="text" id="unit7" name="unit7" placeholder="Unit" class="form-control col-md-1 col-xs-12">
                        </div>
                      </div>
