...
$data_kantor = mysqli_fetch_assoc($query);?>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kantor1">Kantor 1<span class="required">*</span></label>
                        <div class="col-md-8 col-sm-8 col-xs-4">
                          <select class="form-control" id="kantor1" name="kantor1" >
                                <option value="-">-</option>
                            <?php
                                do {?>
